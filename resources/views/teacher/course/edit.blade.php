...
@section('pageContent')
    <div class="col-md-12" id="container" >
        ...
        <div id="course-wrapper" class="col-md-8 col-md-offset-2" style="padding: 0px">
            <div class="container">
                <h2>{{ $course->course_name }}<small></small></h2>
                <form method="post" action="/course/{{ $course->id }}">
                    ...
                    <div class="group">
                        <input type="number" name="total_class" min="1" value="{{ $course->total_class or 30 }}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                    ...
                    <div class="group">
                        <input type="number" name="min_percent_of_attendance" min="0" value="{{ $course->min_percent_of_attendance or 0 }}" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
